...
function RegisterStudent() {
  ...
  return (
    <div className="w-full min-h-[91vh] pt-10 flex flex-col items-center justify-center">
      <h1 className="text-white font-bold text-3xl lg:text-5xl mt-10 mb-5">
        Register Student
      </h1>
        ...
        <form method="post" onSubmit={registerStudent} className="flex flex-col gap-3">
          ...
          <div className="mx-12">
            ...
            <textarea
              ...
              className="border flex-grow sm:text-sm rounded-lg block w-full p-2.5 bg-neutral-700 border-neutral-600 placeholder-gray-400 text-white focus:ring-[#9F6BA0] focus:border-[#9F6BA0] outline-none"
            />
          </div>
