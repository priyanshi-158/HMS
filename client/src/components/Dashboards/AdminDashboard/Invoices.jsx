...
function Invoices() {
  const genInvoices = async () => {
    ...
    try {
      const res = await fetch("https://hostel-management-seven.vercel.app/api/invoice/generate", {
        method: "POST",
        headers: {
  ...
  const approveInvoice = async (id) => {
    setProgress(30);
    try {
      const res = await fetch("https://hostel-management-seven.vercel.app/api/invoice/update", {
        method: "POST",
        headers: {
          "Content-Type": "application/json"
        },
  ...
  const getInvoices = async () => {
    ...
    let hostel = JSON.parse(localStorage.getItem("hostel"));
    try {
      const res = await fetch("https://hostel-management-seven.vercel.app/api/invoice/getbyid", {
        method: "POST",
        headers: {
          "Content-Type": "application/json"
        },
  ...
  return (
    <div className="w-full min-h-[91vh] flex flex-col gap-3 items-center justify-center">
      ...
      <button onClick={genInvoices} className="py-3 px-7 rounded-lg font-bold text-white bg-[#9F6BA0] hover:bg-[#825882] transition-all">
        Generate Invoices
      </button>
