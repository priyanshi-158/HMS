...
function Invoices() {
  ...
  return (
    <div className="w-full min-h-[91vh] flex flex-col gap-5 items-center justify-center pt-10 overflow-y-auto">
      <h1 className="text-white font-bold text-3xl lg:text-5xl">Invoices</h1>
      <p className="text-white text-lg lg:text-xl text-center px-5 sm:p-0">
        All the invoices like Mess bills, Hostel fee will be shown here
      </p>
      <div className="flex gap-10 items-center my-5">
        <div className="flex flex-col items-center justify-center">
          <dt className="mb-2 ml-2 text-3xl lg:text-5xl font-extrabold text-[#825882]">{totalInvoices}</dt>
          <dd className="text-gray-400 text-center">Total Invoices</dd>
        </div>
        <div className="flex flex-col items-center justify-center">
          <dt className="mb-2 text-3xl lg:text-5xl font-extrabold text-[#825882]">{paidInvoices}</dt>
          <dd className="text-gray-400 text-center">
            Paid Invoices
          </dd>
        </div>
        <div className="flex flex-col items-center justify-center">
          <dt className="mb-2 text-3xl lg:text-5xl font-extrabold text-[#825882]">{pendingInvoices}</dt>
          <dd className="text-gray-400 text-center">
            Pending Invoices
          </dd>
        </div>
