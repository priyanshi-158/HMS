...
function Attendance() {
  ...
  return (
    <div className="w-full min-h-[91vh] flex flex-col gap-5 items-center justify-center overflow-y-auto pt-10 ">
      ...
      <div className="flex gap-5 flex-wrap max-h-96 w-full justify-center items-center">
        <Doughnut
          datasetIdKey="id"
          data={{
            labels,
