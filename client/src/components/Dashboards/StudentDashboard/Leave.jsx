...
function Leave() {
  ...
  const labels = ["Leaves", "Requested Leaves", "Present in Hostel"];
  const loader = (
    <svg
      aria-hidden="true"
      className="inline w-4 h-4 mr-2 animate-spin text-white fill-[#825882]"
      viewBox="0 0 100 101"
      fill="none"
  ...
  return (
    ...
    <div className="w-full min-h-[91vh] gap-10 flex flex-col items-center justify-center overflow-y-auto pt-10 ">
      <h1 className="text-white font-bold text-3xl lg:text-5xl">Leaves</h1>
      <ul className="flex gap-5 text-white text-lg lg:text-xl px-5 sm:p-0 text-center">
        <li>Total Working Days: {daysofmonthtilltoday - leave} </li>
      ...
      <div className="w-full gap-10 flex items-center justify-center flex-wrap">
        <div className="md:h-64 h-auto gap-2 flex items-center justify-center flex-wrap">
          <Doughnut
            datasetIdKey="id"
            data={{
              labels,
      ...
      >
        ...
        <button
          type="submit"
          className="w-full text-white bg-[#9F6BA0] hover:bg-[#825882] focus:ring-4 focus:outline-none focus:ring-[#825882] text-xl rounded-lg px-5 py-2.5 mt-5 text-center"
        >
          {loading ? (
