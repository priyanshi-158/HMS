...
function Topbar({ name }) {
  ...
  return (
    <div className="py-5 px-5 flex items-center justify-between text-white w-full bg-stone-950 shadow-lg">
      ...
      <div className="flex gap-3">
        <Link to="settings">
          <svg
            ...
            strokeWidth={1.5}
            stroke="currentColor"
            className="w-6 h-6 hover:text-[#9F6BA0]"
          >
            <path
              strokeLinecap="round"
        ...
        <div className="relative group cursor-pointer" onClick={()=>{setShow(!show)}}>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 24 24"
          ...
          <div className={`absolute bg-neutral-800 -bottom-20 right-2  ${show?"flex":"hidden"} rounded`}  >
